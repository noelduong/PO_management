...
function checkLogin(username, password) {
  try {
    ...
    return { success: false, message: "L�i Server: " + err.toString() };
  }
}
...
function saveOrderData(payload) {
  try {
    ...
    // Đọc header hi�!n tại �Ồ h� trợ c�"t size ��"ng
    ...
    items.forEach(it => {
      ...
      if (currentHeaders.indexOf("Đ�ng b�" NPL") >= 0) rowData[currentHeaders.indexOf("Đ�ng b�" NPL")] = "Pending";
...
function migrateOrderSummaries() {
  ...
  if (headers.length < 24) {
    orderSheet.getRange(1, 22).setValue("T�"ng SL");
...
function saveNplApproval(payload) {
  try {
    ...
    const colNpl = headers.indexOf("Đ�ng b�" NPL") + 1;
...
function saveReceivingData(payload) {
  try {
    ...
    items.forEach(it => {
      ...
      rowData[currentHeaders.indexOf("T�"ng SL nhận")] = totalQty;
...
function autoPassNplForOldReceivings() {
  ...
  // 3. Cập nhật trong data_order_details (C�"t Đ�ng b�" NPL - Index 12)
  const detailSheet = ss.getSheetByName("data_order_details");
  if (detailSheet) {
    const detailData = detailSheet.getDataRange().getValues();
...
function importPart1() {
  ...
  o.forEach(function(row) {
    ...
    row[15] = toDate(row[15]); // Hạn Duy�!t
...
/**
 * Ch�y h�m n�y 1 l�n sau khi X�A S�CH data tr�n Sheet.
 * Import d� li�u: �n h�ng, Chi ti�t �n h�ng v� Nh�p kho.
 */
function masterImportFromCSV() {
  ...
  var detailSheet = ss.getSheetByName("data_order_details");
  if (!detailSheet) detailSheet = ss.insertSheet("data_order_details");
  var detailHeaders = ["M� �n h�ng","T�n SP","Art Code","M�u","T�ng SL","�n gi�","Th�nh ti�n (tr��c VAT)","Th�ng tin NPL","T.Gian Giao","Ghi Ch�","Tr�ng th�i V�i","Tr�ng th�i Bo","�ng b� NPL","Ng�y �ng b�","Ghi ch� duy�t","Size S","Size M/29","Size L/30","Size XL/31","Size XXL/32","Size 34","Size FREE"];
  detailSheet.clearContents();
  ...
  detailSheet.setFrozenRows(1);
  var detailData = [["0003/2026/PLMR-TLN","BASIC SYMBOL","PO88","KEM V�NG NEW",1000,112860,112860000,"","2026-03-14","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",250,350,250,150,"",""],["0004/2026/PLMR-TLN","BASIC SYMBOL","PO88","KHAKI NEW",800,112860,90288000,"","2026-03-14","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",225,225,200,150,"",""],["0005/2026/PLMR-TLN","BASIC SYMBOL","PO88","BE NH�T",700,112860,79002000,"","2026-03-18","Ho�n th�nh","Pending","Pending","Pending","","","",200,250,150,100,"",""],["0006/2026/PLMR-TLN","BASIC SYMBOL","PO88","�T",700,112860,79002000,"","2026-03-18","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",200,250,150,100,"",""],["0009/2026/PLMR-AT","BASIC DIAMOND","PO166","TR�NG KEM",1000,127440,127440000,"","2026-03-11","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",300,300,250,150,"",""],["0010/2026/PLMR-AT","BASIC DIAMOND","PO166","BE",1000,127440,127440000,"","2026-03-11","Ho�n th�nh","Pending","Pending","Pending","","","",300,300,250,150,"",""],["0011/2026/PLMR-AT","BASIC DIAMOND","PO166","XANH KH�I",600,127440,76464000,"","2026-03-13","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",150,200,150,100,"",""],["0012/2026/PLMR-AT","BASIC DIAMOND","PO166","XANH DENIM",600,127440,76464000,"","2026-03-11","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",150,200,150,100,"",""],["0013/2026/PLMR-AT","BASIC DIAMOND","PO166","XANH MINT",600,127440,76464000,"","2026-03-13","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",150,200,150,100,"",""],["0019/2026/PLMR-TLN","BASIC SYMBOL","PO88","� N�U",800,112860,90288000,"","2026-03-13","Ho�n th�nh","Pending","Pending","Pending","","","",225,225,200,150,"",""],["0020/2026/PLMR-TLN","BASIC SYMBOL","PO88","X�M �M NEW",800,112860,90288000,"","2026-03-20","Ho�n th�nh","Pending","Pending","Pending","","","",225,225,200,150,"",""],["0021/2026/PLMR-TLN","BASIC SYMBOL","PO88","N�U NH�T",800,112860,90288000,"","2026-03-20","Ho�n th�nh","Pending","Pending","Pending","","","",225,225,200,150,"",""],["0022/2026/PLMR-TLN","BASIC SYMBOL","PO88","BE H�NG",800,112860,90288000,"","2026-03-21","Ho�n th�nh(thi�u)","Pending","Pending","Pending","","","",225,225,200,150,"",""],["0028/2026/PLMR-TLN","ASTON PMD31","PO253","EN 84",600,201528,120916800,"","2026-03-11","Ho�n th�nh","Pending","Pending","Pending","","",125,250,175,50,"","",""]];
  ...
  var orderSheet = ss.getSheetByName("data_order");
  if (!orderSheet) orderSheet = ss.insertSheet("data_order");
  var orderHeaders = ["Th�i gian l�u","M� �n h�ng","Ng�y �t h�ng","Ng��i t�o","C�ng ty","Nh� cung c�p","�a ch� NCC","Thu� VAT (%)","T�ng t�m t�nh","Ti�n VAT","T�ng c�ng","PO Th�ng","Ph�n lo�i s�n ph�m","Ph�n c�p s�n ph�m","Tr�ng th�i V�i","H�n Duy�t (D+18)","H�n C�t V�i (D+21)","H�n L�n Chuy�n (D+22)","H�n Ho�n Th�nh (D+27)","Tr�ng th�i Bo","Tr�ng th�i NPL","Ng�y �ng B�","Ghi Ch�","T�ng SL","Danh s�ch SP","Danh s�ch M�u"];
  orderSheet.clearContents();
  ...
  SpreadsheetApp.getUi().alert("� ph�c h�i xong to�n b� d� li�u: �n h�ng, Chi ti�t �n h�ng v� Nh�p kho!");
}

/**
 * Import d� li�u nh�p h�ng t� CSV g�c.
 */
function importReceiving() {
  function toDate(s){if(!s)return"";var str=String(s);var m=str.match(/(\d{4})-(\d{2})-(\d{2})/);if(m)return new Date(parseInt(m[1]),parseInt(m[2])-1,parseInt(m[3]));return s;}
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet = ss.getSheetByName("data_receiving");
  if (!sheet) sheet = ss.insertSheet("data_receiving");
  var h=["Th�i gian l�u","M� �n h�ng","PO Th�ng","Ng��i nh�p","Ng�y nh�p","�t nh�p","T�n SP","Art Code","M�u","T�ng SL nh�n","Ghi ch�","Size S/29","Size M/30","Size L/31","Size XL/32","Size XXL/34","Size FREE"];
  sheet.clearContents();
  sheet.getRange(1,1,1,h.length).setValues([h]);
  sheet.getRange(1,1,1,h.length).setFontWeight("bold").setBackground("#d9ead3");
  sheet.setFrozenRows(1);
  var d=[["2026-05-06T02:30:00.000Z","0003/2026/PLMR-TLN","","System Import","2026-03-13","�t 1","BASIC SYMBOL","PO88","KEM V�NG NEW",665,"","",166,233,166,100,""]];
  var nc=h.length;
  d=d.map(function(r){var row=r.slice(0,nc);while(row.length<nc)row.push("");row[4]=toDate(row[4]);return row;});
  if(d.length>0)sheet.getRange(2,1,d.length,nc).setValues(d);
  if(d.length>0)sheet.getRange(2,5,d.length,1).setNumberFormat("dd/mm/yyyy");
